...
## Overview
  ...
  * **The Approach** The approach in this repository formulates the problem as a classification task, using the sklearn models LinearRegression, DecisionTreeRegressor, and RandomForestRegressor. The 3 different models were compared and found that RandomForestRegressor was the best performer. This dataset was artificially generated by a deep learning model based on an original real world dataset that was not factored into this approach.
  * **Performance** The 3 models performed as follows using R2 as the metric:: LinearRegression: 0.28; DecisionTreeRegressor: 0.26; RandomForestRegressor: 0.30.

## Summary of Workdone

The given dataset generated by the Kidney Stone Prediction based on Urine Analysis deep learning model was separated into two groups of positive and negative diagnoses and used for visual analysis. Then the first 90% of the tests were used for testing and the last 10% were used for benchmarking.  
